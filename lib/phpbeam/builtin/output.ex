defmodule PhpBeam.Builtin.OutputFns do
  @moduledoc """
  Output/format/json/date builtins (moved from Builtin so it is a pure
  registry): var_dump/print_r/var_export/sprintf/printf, json_*,
  define/defined/constant, time/microtime/date.
  """
